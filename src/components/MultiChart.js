...
export default function MultiChart() {
  ...
  return (
    <>
      {activeMetrics.map(i => {
        if (injValveData[0] && i.metricName === injValveData[0].metric) {
          return (
            <Card
        ...
        } else if (oilTempData[0] && i.metricName === oilTempData[0].metric) {
          return (
            <Card
              color={colors[i.metricName]}
              metric={names[i.metricName]}
        ...
        } else if (flareTempData[0] && i.metricName === flareTempData[0].metric) {
          return (
            <Card
              color={colors[i.metricName]}
              metric={names[i.metricName]}
        ...
        } else if (waterTempData[0] && i.metricName === waterTempData[0].metric) {
          return (
            <Card
              color={colors[i.metricName]}
              metric={names[i.metricName]}
        ...
        } else if (casingPressureData[0] && i.metricName === casingPressureData[0].metric) {
          return (
            <Card
              color={colors[i.metricName]}
              metric={names[i.metricName]}
        ...
        } else if (tubingPressureData[0] && i.metricName === tubingPressureData[0].metric) {
          return (
            <Card
              color={colors[i.metricName]}
              metric={names[i.metricName]}
